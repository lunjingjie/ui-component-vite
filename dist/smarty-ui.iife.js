...
var SmartUI = function(exports, vue2) {
  ...
  const MyButton = vue2.defineComponent({
    ...
    setup(props2, {
      ...
      return () => vue2.createVNode("button", {
        "class": `
        mx-2
        py-2
        px-4
        ...
        cursor-pointer
      `
      }, [props2.icon !== "" ? vue2.createVNode("i", {
        "class": `i-ic-baseline-${props2.icon} p-3`
      }, null) : "", slots.default ? slots.default() : ""]);
    }
  });
  const _hoisted_1 = /* @__PURE__ */ vue2.createElementVNode("button", null, "SFC Button", -1);
  const _hoisted_2 = /* @__PURE__ */ vue2.createTextVNode("\u6D4B\u8BD5\u6309\u94AE");
  const _sfc_main = /* @__PURE__ */ vue2.defineComponent({
    __name: "SFCButton",
    setup(__props) {
      return (_ctx, _cache) => {
        return vue2.openBlock(), vue2.createElementBlock(vue2.Fragment, null, [
          _hoisted_1,
          vue2.createVNode(vue2.unref(MyButton), null, {
  ...
  const JSXButton = vue2.defineComponent({
    ...
    render() {
      ...
      }, [vue2.createTextVNode("JSXButton")]);
    }
  });
  const entry = {
    install(app) {
